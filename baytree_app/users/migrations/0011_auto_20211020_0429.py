        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    choices=[('Active', 'Active'), ('Withdrawn', 'Withdrawn'), ('On Hold', 'On Hold'),
                             ('Temporarily Withdrawn', 'Temporarily Withdrawn'), ('Future Leaver', 'Future Leaver'),
                             ('Staff', 'Staff'), ('Inactive', 'Inactive')], max_length=30)),
            ],
        ),
