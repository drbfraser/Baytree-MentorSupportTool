...
from .views import StatisticViews, postUser, resetAccountPassword, sendAccountCreationEmail, createMentorAccount, sendResetPasswordEmail, checkMentorHasLoggedIn
...
urlpatterns = [
    ...
    path('hasMentorLoggedIn', checkMentorHasLoggedIn)
]
