...
export const getGoalCategories = rest.get<DefaultBodyType, PathParams<string>, GoalCategory[]>(`${goalUrl}/categories`, (req, res, ctx) => {
  return res(ctx.json(mockGoalCateogories))
});

export const getGoals = rest.get<DefaultBodyType, PathParams<string>, GoalResult>(goalUrl, (req, res, ctx) => {
  return res(ctx.json({
...
export const getStatistics = rest.get<DefaultBodyType, PathParams<string>, GoalStatistics>(`${goalUrl}/statistics`, (req, res, ctx) => {
...
export const getGoalDetail = rest.get<DefaultBodyType, PathParams<"goalId">, GoalDetail>(`${goalUrl}/:goalId/`, (req, res, ctx) => {
