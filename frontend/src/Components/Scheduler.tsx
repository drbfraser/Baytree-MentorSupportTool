...
const Scheduler: React.FC<Props> = ({height}) => {
    ...
    const DurationToEndDate = (startDate: Date, duration: string ) => {
        ...
        endDate.setMinutes(startDate.getMinutes() + parseInt(durationHourMinute[1]));
        return endDate;
    }
    ...
    useEffect(() => {
        ...
        .then ((data: string) => {
            setSessionList(JSON.parse(data).map((values:any, index:any) => ({
        ...
        <div>
            ...
            >
                ...
                <DialogContent>
                    ...
                    <DialogContentText>Start Date and Time: {moment(startDate).format('YYYY/DD/MM hh:mm a')}</DialogContentText>
                    <DialogContentText>End Date and Time: {moment(endDate).format('YYYY/DD/MM hh:mm a')}</DialogContentText> 
