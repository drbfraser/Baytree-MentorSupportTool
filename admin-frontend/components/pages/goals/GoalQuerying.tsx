...
export const GoalCategoryFilter: FunctionComponent<Props> = ({
  query,
  handleChangeQuery
}) => {
  ...
  useEffect(() => {
    backendGet<GoalCategory[]>('goals/categories/')
      .then((data) => {
...
export const GoalDateOrdering: FunctionComponent<Props> = ({
  query,
  handleChangeQuery
}) => {
  return (
...
export const GoalSearch: FunctionComponent<Props> = ({
  query,
  handleChangeQuery
}) => {
  const updateSearch = (
