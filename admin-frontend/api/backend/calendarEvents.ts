...
export const createCalendarEvent = async (calendarEvent: CalendarEvent) => {
  return await backendPost(
    `${calendarEventsBackendEndpoint}create/`,
    calendarEvent
  )
}

export const deleteCalendarEvent = async (calendarEventId: number) => {
  return await backendDelete(
    `${calendarEventsBackendEndpoint}${calendarEventId}/`
  )
}

export const updateCalendarEvent = async (calendarEvent: CalendarEvent) => {
  return await backendPut(
    `${calendarEventsBackendEndpoint}${calendarEvent.id}/`,
    calendarEvent
  )
}
